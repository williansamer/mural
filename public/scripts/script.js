...
function updatePosts(){
    ...
    fetch("https://lesson-mural.herokuapp.com/api/all")
        .then((res)=>{
...
function newPost(){
    ...
    fetch("https://lesson-mural.herokuapp.com/api/new", options) //Chamando a 'url' e criando o 'options' para gravar no BACKEND
...
function delPost(el){
    ...
    fetch("https://lesson-mural.herokuapp.com/api/del", options)
        .then(()=>{ 
            updatePosts();
        })
